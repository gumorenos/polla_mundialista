...
vi.mock('../api/hooks', () => ({
  ...
  useBracketLatest: () => ({ data: null, isLoading: false, error: null }),
  useBracketRuns: () => ({ data: null, isLoading: false, error: null }),
  useRunBracketSimulation: () => ({ mutate: vi.fn(), isPending: false, isSuccess: false, isError: false, data: null }),
}))
